...
function setup() {
  ...
  button1.position(150,70);
  button1.size(50,50);
  button1.mouseClicked(drop1);

  button2 = createImg('cut_btn.png');
  button2.position(730,50);
  button2.size(50,50);
  ...
  rope = new Rope(3,{x:545,y:30});
  rope1 = new Rope(12,{x:175,y:70});
  rope2 = new Rope(8,{x:755,y:50});
  ground = new Ground(200,H-10,W+1000,20);
...
function draw() 
{
  ...
  if(keyDown(RIGHT_ARROW)&&bunny.x<W-50){
    bunny.x=bunny.x+5;}
   if(keyDown(LEFT_ARROW)&&bunny.x>5){
    bunny.x=bunny.x-5;}
